...
@section('content')
    <div class="container bg-transparant" style="padding-top: 100px;">
        ...
        <div class="breadcrumb mb-4" style="color: black; font-weight: bold;">
            <a class="me-2" href="/">
                <i class="bi bi-house-door" style="color: black; "></i> <!-- Bootstrap Icons Home Icon -->
            </a>
            <a class="me-2" href="/" style="color: black; " >Home</a>
            <span class="me-2">></span> <!-- Separator -->
            <a class="me-2" style="color: black; ">Cart</a>
        </div>
        ...
        <a href="{{ route('checkout') }}">
            <!-- Checkout Button -->
            <div class="d-flex justify-content-end mt-3">
                <button type="button" class="btn" style="background-color: #ED127C; color: white;">Checkout</button>
            </div>
        </a>
