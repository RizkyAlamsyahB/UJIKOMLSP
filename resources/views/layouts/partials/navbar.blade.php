        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="/home">
                            <img id="logo" src="{{ asset('template/dist/assets/compiled/png/medical_life.png') }}"
                    ...
                    <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarSupportedContent">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                                <li>
                                    <h6 class="dropdown-header" style="color: #4a90e2;">Hello, {{ Auth::user()->name }}</h6> <!-- Color for username -->
                                </li>
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ route('logout') }}" style="color: #7D0A0A;"
